...
static const char *spi1 = "/dev/spidev1.0";//kkkkkkkkkkkkkkk for 3018 2.0.
static	int fd_spi0=0,fd_spi1=0;

static uint8_t mode = SPI_MODE_0 ;//| SPI_CS_HIGH;//     SPI_MODE_2(SPI_CPOL|0)  SPI_MODE_3	(SPI_CPOL|SPI_CPHA);
