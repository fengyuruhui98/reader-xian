...
//预定义
//---------------------------------------------------------------
//#define rc0_rst_set()    {gpd_set_bit(BIT08_MASK);}
//#define rc0_rst_clr()    {gpd_clr_bit(BIT08_MASK);}
//#define rc0_irq()        (gpf_rd16()&BIT00_MASK)
//#define rc0_cs_set()     {gpj_set_bit(BIT11_MASK);}
//#define rc0_cs_clr()     {gpj_clr_bit(BIT11_MASK);}
//
//#define rc1_rst_set()    {gpd_set_bit(BIT09_MASK);}		{wgGPDValue|=bit_mask;iowrite32(wgGPDValue,S3C2410_GPDDAT);}
//															#define S3C2410_GPDDAT      S3C2410_GPIOREG(0x34)
//#define rc1_rst_clr()    {gpd_clr_bit(BIT09_MASK);}		{wgGPDValue&=(UWORD)(~bit_mask);iowrite32(wgGPDValue,S3C2410_GPDDAT);
//#define rc1_irq()        (gpf_rd16()&BIT01_MASK)			ioread32(S3C2410_GPFDAT)
//															#define S3C2410_GPFDAT      S3C2410_GPIOREG(0x54)
//#define rc1_cs_set()     {gpj_set_bit(BIT10_MASK);}		{wgGPJValue|=bit_mask;iowrite32(wgGPJValue,S3C2440_GPJDAT);}
//#define rc1_cs_clr()     {gpj_clr_bit(BIT10_MASK);}		{wgGPJValue&=(UWORD)(~bit_mask);iowrite32(wgGPJValue,S3C2440_GPJDAT);}
...
#define PICC_COMPATIBILITYWRITE         0xA0			// write block
...
//变量定义
//变量定义
extern uint8_t gRc500Key[6];
extern uint8_t gThisCardSnr[13];
extern uint8_t gNhhFlag;
extern uint8_t bgRfNow;
