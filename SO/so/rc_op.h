...
//预定义------------------------------------------------------------------------
#define REQ_TIME_OUT    34//2014-05-22 14:20:4140 //7      //3-->1ms,20-->3ms,2012/8/22 17:34:55
#define SEL_TIME_OUT    14     //2ms
#define AUTH_TIME_OUT   20     //3ms
#define HALT_TIME_OUT   7      //1ms
#define READ_TIME_OUT   20     //3ms
...
//2013/8/27 9:33:29
void rc_set_speed(UBYTE tx_speed,UBYTE rx_speed);
UBYTE rc_pps(UBYTE cid,UBYTE pps1,UBYTE *ppss);
