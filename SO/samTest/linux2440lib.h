...
#define SAM_ETU_32        (256-(32/2))		//115200
#define SAM_ETU_57600   (256-(62/2))    //57600,62
...
//
//3.1.4	SAM卡PTS设置
int sam_pps0(int channel, int ta1, UBYTE *outbuf, UBYTE *outlen);
...
//timeout为超时时间，单位毫秒
//Expectlen =0 判断超时，！=0 接收长度expectlen后立即返回，若长度不足expectlen并超时则判错
//返回值：0成功
//        -1 参数错误或命令错误
//
//3.2	射频应用
